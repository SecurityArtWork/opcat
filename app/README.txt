Para el descubrimiento y visualización de servicios web se deberán llevar a cabo los siguientes pasos:
	...
	2-. Al descubrir al menos un servicio podrá visualizar la información recolectada haciendo uso del script 		localizado en 'scanner/app/web_service.py'.

	3-. Para acceder al servicio WEB habilitado como Front-end de la aplicación, deberá acceder a la siguiente 		URL, http://<dirección ip>:8888

	4-. Si desea modificar el puerto de escucha habilitado por Tornado para acceder al servicio web, deberá 		modificar la línea 109 del fichero 'scanner/app/web_service.py'
